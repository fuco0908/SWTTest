...
public class updateGame extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateGame(GameID, GameName, GameGenre, Publisher, Price, Description, OS, Processor, Memory, Graphics, DirectX, Network, Storage, ReleaseDay, image1, image2, image3, image4, link);
        request.setAttribute("mess7", "update game info success!");
