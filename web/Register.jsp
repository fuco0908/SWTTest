<%-- 
    Document   : Registe
    Created on : 25 thg 2, 2024, 16:07:53
    Author     : Lenovo
--%>
...
<html lang="en">
    ...
    <body style="margin-top: -100px">
        ...
        <link rel="stylesheet" href="assets/css/login-style.css">
        <main>
            <div class="container" id ="main" style="height: 550px">
                <div class="sign-in" style="height: 600px">
                    <!-- ***** sign up ***** -->
                    <form action="register" method="post">
                        <h1>Create Account</h1>
                        <div class="social-container">
                ...
                <div class="overlay-container">
                    <div class="overlay">
                        <div class="overlay-right">
                            ...
                            <button id="signIn"> <a href="Login.jsp">Sign Up</a></button>
                        </div>
<!--                        <div class="overlay-right">
                            <h1>Hello, Friend!</h1>
